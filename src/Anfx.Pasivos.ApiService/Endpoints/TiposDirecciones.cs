...
//        // GET all
//        group.MapGet("/all", GetTipoDireccionAll)
...
//        // GET paginados
//        group.MapGet("/", GetTipoDireccionPaginados)
...
//        // GET by id
//        group.MapGet("/{id}", GetTipoDireccionById)
...
//        // POST create
//        group.MapPost("/", CreateTipoDireccion)
...
//        // PUT update
//        group.MapPut("/{id}", UpdateTipoDireccion)
...
//        // DELETE
//        group.MapDelete("/{id}", DeleteTipoDireccion)
...
//        // GET export to Excel
//        group.MapGet("/exportar", ExportToExcelTipoDireccion)
