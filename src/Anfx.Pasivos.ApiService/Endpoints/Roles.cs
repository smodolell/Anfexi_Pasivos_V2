...
//        group.MapGet("/paginados", GetRolPaginados)
...
//        group.MapGet("/nombre/{nombre}", GetRolByName)
...
//        group.MapGet("/{id}/exists", RolExists)
//            .WithName("RolExists")
...
//        group.MapGet("/select-list", GetRolSelectList)
