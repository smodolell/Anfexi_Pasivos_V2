...
public class PSV_Contrato
{
    ...
    public virtual PSV_EstatusContrato PSV_EstatusContrato { get; set; } = null!;
    ...
    public virtual PSV_TipoCredito PSV_TipoCredito { get; set; } = null!;
    ...
    public virtual SB_Periodicidad SB_Periodicidad1 { get; set; } = null!;
    public virtual SB_TipoMoneda SB_TipoMoneda { get; set; } = null!;
    public virtual Tasa Tasa1 { get; set; } = null!;
    public virtual Tasa Tasa2 { get; set; } = null!;
    public virtual ICollection<PSV_ContratoPagoIrregular> PSV_ContratoPagoIrregular { get; set; } = new HashSet<PSV_ContratoPagoIrregular>();
    public virtual ICollection<PSV_Movimiento> PSV_Movimiento { get; set; } = new HashSet<PSV_Movimiento>();
    public virtual ICollection<PSV_RelActivoPasivo> PSV_RelActivoPasivo { get; set; } = new HashSet<PSV_RelActivoPasivo>();
    public virtual PSV_TipoTablaAmortiza PSV_TipoTablaAmortiza { get; set; } = null!;
    public virtual ICollection<PSV_TablaAmortiza> PSV_TablaAmortiza { get; set; } = new HashSet<PSV_TablaAmortiza>();
